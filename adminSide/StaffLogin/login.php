...
<head>
    ...
    <style>
         body {
            ...
            background-image: url('../../customerSide/image/background.jpg');
            background-size: cover; /* Scale the image to be contained within the body */
...
<body>
    ...
    <a class="nav-link" href="../../customerSide/home/home.php"> <h1 class="text-center" style="font-family:Copperplate; color:black;"> FLAVORSCAPE</h1><span class="sr-only"></span></a>
