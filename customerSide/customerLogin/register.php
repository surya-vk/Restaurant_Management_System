...
<body>
    ...
    <div class="register_wrapper"> <!-- Updated class name -->
        <a class="nav-link" href="../home/home.php#hero"> <h1 class="text-center" style="font-family:Copperplate; color:black;"> FLAVORSCAPE</h1><span class="sr-only"></span></a><br>
        ...
        <p style="margin-top:1em; color:black;">Already have an account? <a href="../customerLogin/login.php" >Proceed to Login</a></p>
    </div>
    </div>
</body>
</html>