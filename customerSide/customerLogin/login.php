...
<body>
    ...
    <div class="login_wrapper">
        <a class="nav-link" href="../home/home.php#hero"> <h1 class="text-center" style="font-family:Copperplate; color:black;"> FLAVORSCAPE</h1><span class="sr-only"></span></a>
    ...
    <span class="text-danger"><?php echo $password_err; ?></span>
            ...
            <p style="margin-top:1em; color:black;">Don't have an account? <a href="register.php" style="">Proceed to Register</a></p>
        </div>
    </div>
    </div>
</body>
